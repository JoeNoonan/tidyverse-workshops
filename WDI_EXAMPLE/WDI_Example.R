...
### Save % of refugees plot 

ggsave(filename= "percent_refg_plot.png", plot=percent_refg_plot, width = 30, height = 20, units = "cm", scale = 1)

### Total number of refugees plot
...
### Save total # of refugees plot 

ggsave(filename= "total_refg_plot.png", plot=total_refg_plot, width = 30, height = 20, units = "cm", scale = 1)